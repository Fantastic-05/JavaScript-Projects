...
var message = "Hello! This is a string assignment.";
window.alert(message);

var message = "The teacher said, \"Don\'t forget to hand in your homework!\"";
window.alert(message);
...
var firstname = "Jenny", age = 14, favouriteColor = "Pink";
